...
export async function genWasm(ts: TypeSystem, cppFolder: string, jsBaseClass: string, outFolder: string, debugMode?: boolean) {
    ...
    const uapiDefs = `-DROOT_JS_CLASS=${jsBaseClass} -DBUILD_TYPESCRIPT=1 -DZIP_ASSETS=1`
